...
func (p *EchoServiceClient) Echo(ctx context.Context, req *Request) (r *Response, err error) {
...
func (p *EchoServiceClient) VisitOneway(ctx context.Context, req *Request) (err error) {
	var _args EchoServiceVisitOnewayArgs
	_args.Req = req
...
func NewEchoServiceProcessor(handler EchoService) *EchoServiceProcessor {
	...
	self.AddToProcessorMap("VisitOneway", &echoServiceProcessorVisitOneway{handler: handler})
	return self
}
...
func (p *EchoServiceVisitOnewayArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServiceVisitOnewayArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EchoServiceVisitOnewayArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
...
func (p *EchoServiceVisitOnewayArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *EchoServiceVisitOnewayArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *EchoServiceVisitOnewayArgs) DeepEqual(ano *EchoServiceVisitOnewayArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *EchoServiceVisitOnewayArgs) Field1DeepEqual(src *Request) bool {
